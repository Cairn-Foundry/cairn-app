v0.1 -> Mettre en place toutes les pages et interfaces pour une v1.0
v0.2 -> Page d'accueil, des projets et des instances Git fonctionnels
v0.3 -> Editeur de code fonctionnel et intégration des projets et des instances en local
...
v0.12 -> Plusieurs choix d'agents IA CLI et API Key