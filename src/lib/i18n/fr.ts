export const fr = {
  ...
  addProject: {
    ...
    hintNew: 'Choisissez le dossier où se trouve ce projet. Tout répertoire fonctionne, git n\'est pas requis.',
    hintOpen: 'Sélectionnez un dossier local à ouvrir en tant que projet Cairn.',
    ...
    sshHint: 'Clone via SSH. Nécessite une clé SSH configurée pour l\'hôte distant.',
    cloneAndOpen: 'Cloner & ouvrir',
    addProject: 'Ajouter le projet',
    previewFallback: 'Nom du projet',
    duplicateError: (name: string) => `"${name}" utilise déjà ce dossier. Ouvrez-le depuis la liste des projets.`,
  },
  ...
  createInstance: {
    ...
    localOnlyDesc: 'Travaillez avec une branche et un worktree dans votre projet local.',
    ...
    duplicateBranch: (name: string) => `Une branche nommée ${name} existe déjà dans ce projet.`,
    ...
    summaryNoteGit: 'Cairn créera la branche, extraira un worktree et démarrera l\'agent avec le contexte du ticket.',
    summaryNoteLocal: 'Cairn démarrera l\'agent dans un worktree avec le contexte du ticket. Aucune opération git ne sera effectuée.',
  ...
  shortcuts: {
    ...
    defs: {
      quickOpen:          { label: 'Ouverture rapide',              description: 'Ouvrir un fichier par son nom dans le projet courant' },
      searchFiles:        { label: 'Rechercher dans les fichiers',  description: 'Recherche plein texte dans tous les fichiers du projet' },
      splitEditor:        { label: 'Basculer l\'éditeur partagé',   description: 'Diviser l\'éditeur en deux panneaux côte à côte' },
      fontSizeUp:         { label: 'Augmenter la taille de police', description: 'Augmenter la taille de police de l\'éditeur de 1 px' },
      fontSizeDown:       { label: 'Réduire la taille de police',   description: 'Réduire la taille de police de l\'éditeur de 1 px' },
      fontSizeReset:      { label: 'Réinitialiser la taille',       description: 'Réinitialiser la taille de police à la valeur par défaut (13 px)' },
      toggleLineComment:  { label: 'Commenter la ligne',            description: 'Commenter ou décommenter la ligne courante' },
      toggleBlockComment: { label: 'Commentaire de bloc',           description: 'Entourer la sélection d\'un commentaire de bloc' },
      moveLineUp:         { label: 'Déplacer la ligne vers le haut',description: 'Déplacer la ligne courante vers le haut' },
      moveLineDown:       { label: 'Déplacer la ligne vers le bas', description: 'Déplacer la ligne courante vers le bas' },
      copyLineDown:       { label: 'Copier la ligne vers le bas',   description: 'Dupliquer la ligne courante en dessous' },
      deleteLine:         { label: 'Supprimer la ligne',            description: 'Supprimer la ligne courante' },
      selectLine:         { label: 'Sélectionner la ligne',         description: 'Sélectionner toute la ligne courante' },
      matchingBracket:    { label: 'Aller au bracket correspondant',description: 'Déplacer le curseur vers le bracket correspondant' },
      indentMore:         { label: 'Indenter',                      description: 'Augmenter l\'indentation de la ligne courante' },
      indentLess:         { label: 'Désindenter',                   description: 'Réduire l\'indentation de la ligne courante' },
      expandSelection:    { label: 'Étendre la sélection',          description: 'Étendre la sélection au nœud de syntaxe parent' },
      closeTab:           { label: 'Fermer l\'onglet',              description: 'Fermer l\'onglet d\'éditeur actif' },
      reopenClosedTab:    { label: 'Rouvrir l\'onglet fermé',       description: 'Rouvrir le dernier onglet fermé' },
      nextTab:            { label: 'Onglet suivant',                description: 'Passer à l\'onglet ouvert suivant' },
      prevTab:            { label: 'Onglet précédent',              description: 'Passer à l\'onglet ouvert précédent' },
      tabHistoryBack:     { label: 'Historique d\'onglets arrière', description: 'Revenir à l\'onglet précédemment actif' },
      tabHistoryForward:  { label: 'Historique d\'onglets avant',   description: 'Avancer dans l\'historique des onglets' },
      toggleSidebar:      { label: 'Afficher/masquer la barre lat.', description: 'Afficher ou masquer la barre latérale de l\'arborescence' },
      commandPalette:     { label: 'Palette de commandes',          description: 'Ouvrir la palette de commandes pour rechercher toutes les actions' },
      openSettings:       { label: 'Ouvrir les paramètres',         description: 'Ouvrir le panneau des paramètres' },
      goToLine:           { label: 'Aller à la ligne',              description: 'Aller à un numéro de ligne spécifique' },
      addCursorAbove:     { label: 'Ajouter un curseur au-dessus',  description: 'Ajouter un curseur supplémentaire sur la ligne au-dessus' },
      addCursorBelow:     { label: 'Ajouter un curseur en dessous', description: 'Ajouter un curseur supplémentaire sur la ligne en dessous' },
      saveFile:           { label: 'Enregistrer le fichier',        description: 'Enregistrer explicitement le fichier actif' },
      duplicateLine:      { label: 'Dupliquer la ligne',            description: 'Dupliquer la ligne courante, le curseur reste sur l\'originale' },
      treeSelectAll:      { label: 'Tout sélectionner',             description: 'Sélectionner tous les fichiers et dossiers visibles dans l\'arborescence' },
      treeCopy:           { label: 'Copier le(s) fichier(s)',       description: 'Copier le(s) fichier(s) sélectionné(s) dans le presse-papiers' },
      treeCut:            { label: 'Couper le(s) fichier(s)',       description: 'Couper le(s) fichier(s) sélectionné(s) dans le presse-papiers' },
      treePaste:          { label: 'Coller le(s) fichier(s)',       description: 'Coller le(s) fichier(s) du presse-papiers dans le dossier actif' },
      treeDelete:         { label: 'Supprimer le(s) fichier(s)',    description: 'Supprimer le(s) fichier(s) et dossier(s) sélectionné(s)' },
      treeRename:         { label: 'Renommer le fichier',           description: 'Renommer le fichier ou dossier sélectionné' },
      treeNewFile:        { label: 'Nouveau fichier',               description: 'Créer un nouveau fichier dans le répertoire actif' },
      treeNewFolder:      { label: 'Nouveau dossier',               description: 'Créer un nouveau dossier dans le répertoire actif' },
    },
  },
  ...
  agent: {
    ...
    you: 'Vous',
    streaming: 'en cours',
    inputPlaceholder: 'Rediriger l\'agent, poser une question ou ajouter du contexte…',
    sendBtn: 'Envoyer',
  ...
  diffPeek: {
    changesLines: (start: number, end: number) => `Modifications - lignes ${start}–${end}`,
    currentChangesLines: (start: number, end: number) => `Modifications actuelles - lignes ${start}–${end}`,
  ...
  git: {
    ...
    noStagedChanges: 'Aucune modification indexée - indexez des hunks pour commiter.',
  ...
  home: {
    ...
    sections: {
      ...
      checkpointsDesc: 'Revenez à un état sauvegardé de n\'importe quelle instance.',
      checkpointsEmpty: 'Aucun checkpoint pour l\'instant - ils apparaîtront ici au fil des instances.',
      activity: 'Activité',
      activityDesc: 'Événements récents sur toutes les instances.',
      activityEmpty: 'Aucune activité pour l\'instant - les événements apparaîtront ici au fil des instances.',
      account: 'Compte',
    ...
    projects: {
      ...
      emptyProjects: 'Aucun projet pour l\'instant - ouvrez un dossier local ou clonez-en un pour commencer.',
  ...
  deleteProject: {
    ...
    description: 'Cela supprime le projet de Cairn et efface toutes ses instances et worktrees.',
  ...
  settings: {
    ...
    general: {
      groupTitle: 'Général',
      rows: {
        aiProvider: { label: 'Fournisseur IA', desc: 'Driver Agent Bridge', value: 'Claude Code CLI' },
        defaultBranch: { label: 'Branche par défaut', desc: 'Base pour les nouveaux worktrees', value: 'main' },
        worktreeLocation: { label: 'Emplacement des worktrees', desc: 'Où les git worktrees sont créés', value: '~/.cairn/worktrees' },
        formatOnStage: { label: 'Formater à l\'indexation', desc: 'Formater automatiquement avant l\'indexation', value: 'Prettier' },
      },
    },
    appearance: {
      themeGroup: 'Thème',
      ...
      accentColors: {
        ...
        orange: 'Orange', yellow: 'Jaune', green: 'Vert', teal: 'Sarcelle', cyan: 'Cyan',
      },
    },
    editor: {
      ...
      sidebarPositionDesc: 'Déplacer l\'explorateur de fichiers à gauche ou à droite de l\'éditeur.',
      sidebarLeft: 'Gauche',
      sidebarRight: 'Droite',
      treePanelWidth: 'Largeur de l\'arborescence',
      treePanelWidthDesc: 'Largeur du panneau d\'exploration dans la vue Fichiers.',
      ...
      showMinimapDesc: 'Panneau d\'aperçu dans la barre de défilement droite de l\'éditeur.',
      toggleMinimap: 'Basculer la minimap',
      saveOn: 'Enregistrer au',
      saveOnDesc: 'Quand l\'éditeur enregistre automatiquement les fichiers ouverts.',
      resetEditor: 'Réinitialiser l\'éditeur',
      saveOnOptions: {
        blur:           { label: 'Perte de focus',       desc: 'Enregistrer quand l\'éditeur perd le focus' },
        windowChange:   { label: 'Fenêtre inactive',     desc: 'Enregistrer quand la fenêtre perd le focus' },
        projectChange:  { label: 'Changement de projet', desc: 'Enregistrer lors du changement de projet' },
        instanceChange: { label: 'Changement d\'instance', desc: 'Enregistrer lors du changement d\'instance' },
        manual:         { label: 'Manuel',               desc: 'Enregistrer manuellement' },
      },
    },
    project: {
      workflowTabsGroup: 'Onglets du workflow',
      workflowTabsHint: 'Glisser pour réordonner · basculer pour afficher/masquer',
