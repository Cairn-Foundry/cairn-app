export const fr = {
	...
	integrations: {
		title: "Intégrations",
		subtitle:
			"Connectez GitLab, GitHub et Jira pour retrouver tickets, merge requests et pipelines dans Cairn.",
		page: "Intégrations",
	...
	review: {
		...
		unresolve: "Rouvrir",
		resolved: "Résolue",
		addressWithAgent: "Traiter avec l'agent",
		fetchHead: "Récupérer",
		fetchHeadBody:
	...
	tests: {
		...
		noRunnerBody:
			"Cairn a cherché un script de test dans package.json, ainsi que Cargo.toml, pytest et go.mod.",
	...
	home: {
		...
		features: {
			...
			defs: {
				...
				reviewReply: {
					label: "Réponse de review",
					desc: "Transforme un commentaire de review en prompt pour le traiter et le passe à la step Agent.",
				},
			},
		},
		agents: {
...
export const frGreetings = {
	...
	splashes: [
		...
		"Cairn : parce que 'dossierAleatoire123' etait moche.",
