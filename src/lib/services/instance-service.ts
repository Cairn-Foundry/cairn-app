...
export async function createInstance(args: CreateInstanceArgs): Promise<Instance> {
  return invoke<Instance>('create_instance', { args });
}

export async function deleteInstance(id: string, projectId: string): Promise<void> {
